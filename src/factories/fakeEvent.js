...
export default function fakeEvent({
  title = "The Default Show",
  date = moment().format("YYYY-MM-DD"),
  series_id = utils.uniqueID()
}) {
  return {
    name: {
      text: title,
    ...
    id: utils.uniqueID(),
    url:
      "https://www.eventbrite.com.au/e/the-super-secret-test-show-tickets-54744465169",
    start: {
      timezone: "Australia/Melbourne",
      local: `${date}T19:00:00`,
      utc: "2019-03-11T08:00:00Z"
    },
    end: {
      timezone: "Australia/Melbourne",
      local: `${date}T20:00:00`,
      utc: "2019-03-11T09:00:00Z"
    },
    ...
    subcategory_id: null,
    format_id: "6",
    resource_uri: "https://www.eventbriteapi.com/v3/events/54744465169/",
